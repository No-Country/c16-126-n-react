    ...
    try {
      if (horario === "") {
        ...
        const response = await axios.post(
          "https://allservicesapi-production.up.railway.app/api/horarioProfesional",
          {
  ...
  const handleSelectProfesion = async (e) => {
    ...
    try {
      if (!selectedProfesion) {
        ...
        const response = await axios.post(
          "https://allservicesapi-production.up.railway.app/api/cargarOficios",
          {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://allservicesapi-production.up.railway.app/api/profesiones"
        );
  ...
  return (
    <div>
      ...
      <form
        ...
        onSubmit={handleHorarioProfesional}
      >
        ...
        />
        <button
          className="bg-blue-700 text-white rounded-md mt-5 w-[200px] h-[50px] text-[18px]"
          type="submit"
        >
