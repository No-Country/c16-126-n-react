...
const Footer = () => {
    return (
        ...
        <footer className="flex flex-col items-center text-center  text-white bg-blue-600" >
            <div className="container p-6">
                <div>
                    <p className="flex items-center justify-center">
                        ...
                        <button
                            type="button"
                            className="inline-block rounded-full border-2 border-neutral-50 px-6 pb-[6px] pt-2 text-xs
