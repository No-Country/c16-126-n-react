...
import "../Register01/register01.css";
        ...
        <div>
          <form className="flex flex-col items-center p-2 m-3 gap-y-8 ">
            ...
            <div className="flex gap-[1.5rem]">
              <input className="ipt-reg-s" placeholder="Nombre" />

              <input className="ipt-reg-s" placeholder="Apellido" />
            </div>

            <input className="ipt-reg-l" placeholder="Correo Electrónico" />
            ...
            <input className="ipt-reg-l" placeholder="Rol" />
            {!complete && (
              <button
                className="btn-reg"
                onClick={() => {
